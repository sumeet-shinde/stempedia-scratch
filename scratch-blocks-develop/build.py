...
class Gen_compressed(threading.Thread):
    ...
    def do_compile_local(self, params, target_filename):
        ...
        for (arg, value) in params:
            dash_params.append((value,) if arg ==
                               "js_file" else ("--" + arg, value))
        ...
        filesizes = [os.path.getsize(value) for (
            arg, value) in params if arg == "js_file"]
        return dict(
            compiledCode=stdout,
            statistics=dict(
    ...
    def do_compile_remote(self, params, target_filename):
        ...
        conn.request("POST", "/compile",
                     urllib.urlencode(remoteParams), headers)
    ...
    def run(self):
        ...
        try:
            ...
            cmd = [
                ...
                "--source_synonym_file", os.path.join(
...
if __name__ == "__main__":
    try:
        ...
        test_proc = subprocess.Popen(
            test_args, stdin=subprocess.PIPE, stdout=subprocess.PIPE, shell=True)
